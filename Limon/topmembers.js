...
module.exports = {
  config: {
    ...
    prefix: true,
    cooldowns: 10,
    description: "Shows the top 10 members based on message count in the group.",
    usage: [
      `${global.config.PREFIX}topmembers - Displays the top 10 members based on message count.`,
